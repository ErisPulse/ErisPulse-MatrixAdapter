...
class TestConfig:
    """测试配置类"""
    # 适配器配置
    adapter_name: str = "matrix"  # 要测试的适配器名称
    
    # 基础配置
    group_id: str = "!wnmrqPQHlbFUOTZcEW:matrix.org"  # 测试群号
    test_user_id: str = "@erispulse:matrix.org"  # 测试用户ID
    test_user_id_2: str = "@wsu2059:matrix.org"  # 第二个测试用户ID
    ...
    voice_url: str = "https://samplelib.com/wav/sample-3s.wav"
